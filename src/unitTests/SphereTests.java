...
class SphereTests {
		...
		public void testIntersectionPoints() throws Exception{
			...
			Sphere sphere = new Sphere(1, new Point3D(0.0, 0.0, -3.0),new Color(255,128,0),new Material(1,1,1,1,1,1));
			Sphere sphere2 = new Sphere(10, new Point3D(0.0, 0.0, -3.0),new Color(255,128,0),new Material(1,1,1,1,1,1));
