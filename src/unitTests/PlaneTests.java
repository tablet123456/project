...
class PlaneTests {
	...
	public void testIntersectionPoints() throws Exception {
		...
		Plane plane = new Plane(new Point3D(0.0, 0.0, -3.0), new Vector(0.0, 0.0, -1.0),new Color(255,128,0));

		// 45 degrees to the view plane

		Plane plane2 = new Plane(new Point3D(0.0, 0.0, -3.0), new Vector(0.0, 0.25, -1.0),new Color(255,128,0));
